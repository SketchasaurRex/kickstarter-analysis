...
Two conclusions I can draw from the data set is that more plays succeeded than failed and most had goals lower than $10,000.


- What can you conclude about the Outcomes based on Goals?

- What are some limitations of this dataset?
Some of the limitations of the dataset can be highly important information like advertising of the plays and the popularity and appeal before the campaigns launched.

- What are some other possible tables and/or graphs that we could create?
Other tables that could help with visualizing the data are some other charts showing the percent plays funded, the average donation, and how close the failed campaigns were to being successfully funded.
